...
- This module facilitates:
	a. Creation of a new group with provided attributes.
	b. Modification of attributes of existing group.
	c. Deletion of group.
...
Options:
	...
	user_list_type:
		...
		I(members) = Provided user_list_action choice will be performed on members of the group
		I(admins) = Provided user_list_action choice will be performed on admins of the group
		type: str
		default: None
	state:
		description:
	...
	users_list:
		...
		default: None
	remove_keystore:
		description: Specifies if the group's keystore information should be deleted from the system
					while performing the delete operation on group.
		type: bool
		default: True
"""
